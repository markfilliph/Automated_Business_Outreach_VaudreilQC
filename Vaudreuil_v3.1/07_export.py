...
CATEGORY_RULES = [
    ...
    (["metal", "métallurg", "welding", "soudure", "steel", "acier"], "Metal Fabrication"),
    (["wood", "bois", "menuiserie", "ébénisterie", "charpente", "carpentry"], "Wood / Millwork"),
    ...
    (["electrical", "électrique", "électricien"], "Electrical Contractor"),
    (["plumbing", "plomberie", "plombier"], "Plumbing Contractor"),
    (["hvac", "chauffage", "climatisation", "ventilation", "refrigeration", "réfrigération"], "HVAC / Refrigeration"),
    (["roofing", "toiture", "couvreur"], "Roofing Contractor"),
    (["excavation", "excavat", "concrete", "béton", "paving", "pavage", "asphalte"], "Heavy Construction"),
    (["construction", "rénovation", "renovation", "general contractor", "entrepreneur"], "General Contractor"),
    (["insulation", "isolation", "masonry", "maçonnerie", "demolition", "démolition"], "Specialty Trades"),
    (["transport", "trucking", "camionnage", "freight", "fret", "moving", "déménagement"], "Transportation / Logistics"),
    (["warehouse", "entreposage", "entrepôt", "logistics", "logistique"], "Warehousing / Distribution"),
    ...
    (["engineering", "ingénierie", "ingénieur"], "Engineering Services"),
    ...
    (["landscaping", "paysagiste", "aménagement paysager"], "Landscaping"),
    (["security", "sécurité", "gardiennage"], "Security Services"),
    (["equipment", "équipement", "maintenance", "entretien"], "Equipment / Maintenance"),
    (["signage", "enseigne", "affichage"], "Signage / Display"),
    (["pest control", "extermination"], "Pest Control"),
    (["auto repair", "mécanique", "garage"], "Automotive Services"),
    (["towing", "remorquage"], "Towing / Recovery"),
    (["waste", "déchets"], "Waste Management"),
...
def get_industry_label(text: str) -> str:
    ...
    industry_map = [
        ...
        (["construction", "rénovation", "contractor", "entrepreneur"], "construction"),
        ...
        (["consulting", "conseil", "engineering", "ingénierie"], "professional_services"),
...
def transform_row(row: pd.Series) -> dict:
    ...
    if pd.isna(officer_name) or str(officer_name).strip() in ("", "nan", "None", "N/A"):
        ...
        owner_source = "REQ (Registraire des entreprises du Québec)"
